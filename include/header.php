<!-- WOI NI CUMA CUBAAN< JANGAN LUPA TUKAR IF TAK JADI *try to make the visitor for changes* -->
            ...
            <div class="header-wrap">
                ...
                <div class="header-button">
                    ...
                    <div class="account-wrap">
                        ...
                        ?>   
                            <div class="image">
                                <img src="image/icon/icon.jpg" alt="" />
                            </div>
                            <div class="content">
                            ...
                            <div class="account-dropdown js-dropdown">
                                <div class="info clearfix">
                                    <div class="image">
                                        <a href="#">
                                            <img src="image/icon/icon.jpg" alt="John Doe" />
                                        </a>
                                    </div>
                                    <div class="content">
                                        <h5 class="name">
