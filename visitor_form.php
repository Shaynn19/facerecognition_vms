...
$query=mysqli_query($con,"insert into visitor(fullName,email,mobileNo,address,whomToMeet,reasontoMeet) value('$fullname','$email','$mobnumber','$add','$whomtomeet','$reasontomeet')");
