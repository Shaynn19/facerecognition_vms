...
if (strlen($_SESSION['vmsaid']==0)) {
	header('location:logout.php');
} else{
	if(isset($_POST['submit'])){
		
	$adminid=$_SESSION['vmsaid'];
    $AName=$_POST['adminname'];
	$mobno=$_POST['mobilenumber'];
	$email=$_POST['email'];
  
    $query=mysqli_query($con, "update admin set adminName='$AName', mobileNo ='$mobno', email= '$email' where ID='$adminid'");
...
?>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="mobilenumber" name="mobilenumber" class="form-control" maxlength="10" value="<?php  echo $row['mobileNo'];?>" required="">
